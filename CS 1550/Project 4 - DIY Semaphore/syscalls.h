...
asmlinkage long sys_cs1550_seminit(struct cs1550_sem_user __user *sem, int value);
asmlinkage long sys_cs1550_down(struct cs1550_sem_user __user *sem); 
asmlinkage long sys_cs1550_up(struct cs1550_sem_user __user *sem);
